#ifndef THREEPT_CONSTANT_MODEL_H
#define THREEPT_CONSTANT_MODEL_H
...
class threept_constant_model : public abstract_model
{
  public:

    threept_constant_model(string _C_str, string _t_str, string _T_str);
