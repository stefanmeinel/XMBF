...
class chisqr_extra_term
{
  public:
    ...
    void specify_mixed_second_derivatives(const std::vector< std::pair< std::string, std::string > >& mixed_second_derivatives);
  ...
  private:
    ...
    vector< vector< bool > > compute_mixed_second_derivative;
