#ifndef MULTI_EXP_EXPE_2VAR_MODEL_H
#define MULTI_EXP_EXPE_2VAR_MODEL_H
...
class multi_exp_expE_2var_model : public abstract_model
{
  public:

    multi_exp_expE_2var_model(string _E_str, string _dE_str, string _A_str, string _B_str, string _t_str, string _T_str, int n_exp);
    ~multi_exp_expE_2var_model();
